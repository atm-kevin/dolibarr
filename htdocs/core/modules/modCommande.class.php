...
class modCommande extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->export_fields_array[$r] = array(
			...
			'c.date_livraison'=>"DateDeliveryPlanned" ,
			'c.amount_ht'=>"Amount" ,
		...
		$this->export_TypeFields_array[$r] = array(
			...
			'cat2.label'=>'Text' ,
			'cat3.label'=>'Text' ,
			'co.label'=>'List:c_country:label:label' ,
			'co.code'=>'Text' ,
			's.phone'=>'Text' ,
			's.siren'=>'Text' ,
			's.siret'=>'Text' ,
		...
		$this->export_entities_array[$r] = array(
			...
			'c.ref_client'=>"order" ,
			'c.fk_soc'=>"order" ,
			'c.date_creation'=>"order" ,
			'c.date_commande'=>"order" ,
			'c.amount_ht'=>"order" ,
			'c.remise_percent'=>"order" ,
			'c.total_ht'=>"order" ,
			'c.total_ttc'=>"order" ,
			'c.facture'=>"order" ,
			'c.fk_statut'=>"order" ,
			'c.note'=>"order" ,
			'c.date_livraison'=>"order" ,
			'pj.ref'=>'project' ,
			'cd.rowid'=>'order_line' ,
			'cd.label'=>"order_line" ,
			'cd.description'=>"order_line" ,
			'cd.product_type'=>'order_line' ,
			'cd.tva_tx'=>"order_line" ,
			'cd.qty'=>"order_line" ,
			'cd.total_ht'=>"order_line" ,
			'cd.total_tva'=>"order_line" ,
			'cd.total_ttc'=>"order_line" ,
			'p.rowid'=>'product' ,
			'p.ref'=>'product' ,
			'p.label'=>'product'
		);
